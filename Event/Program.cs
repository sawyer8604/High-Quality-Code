...
class Event : IComparable
{
    ...
    {
        Event dateTime = obj as Event;
        int byDate = this.date.CompareTo(dateTime.date);
        int byTitle = this.title.CompareTo(dateTime.title);
        int byLocation = this.location.CompareTo(dateTime.location);
...
class Program
{
    ...
    static class Messages
    {
        ...
        public static void EventDeleted(int output)
        {
            if (output == 0)
            {
                NoEventsFound();
    ...
    class EventHolder
    {
        Dictionary<string, Event> byTitle = new Dictionary<string, Event>();

        SortedSet<Event> byDate = new SortedSet<Event>();
        ...
        {
            SortedSet<Event>.View eventsToShow = byDate.RangeFrom(new Event(
                    date, "", ""),
                    true);
            int showed = 0;
